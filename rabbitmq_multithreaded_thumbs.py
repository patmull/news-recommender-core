...
channel.queue_declare(queue='user-post-thumb_rating-updated-queue', auto_delete=False, durable=True)
channel.queue_bind(queue='user-post-thumb_rating-updated-queue', exchange='user',
