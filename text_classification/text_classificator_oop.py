...
class NeuralNet(object):
    ...
    def set_trainging_data(self):
        ...
        words = [cz_stem(w.lower()) for w in self.words if w not in ignore_words]
...
if __name__ == '__main__':
    ...
    neural_net.set_trainging_data()
    neural_net.build_model()
    neural_net.classify("FAČR o Slavii a Rangers: Věříme v objektivní vyšetření, odmítáme rasismus")
    neural_net.classify("Leicester ve čtvrtfinále Anglického poháru zdolal United, postoupily i City a Chelsea")
    neural_net.classify("Real má po půli dvoubrankový náskok nad Liverpoolem, City vede o gól")
