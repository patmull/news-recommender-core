...
def translate_question_words():
    ...
    with open('../word2vec/analogies/questions-words-cs.txt', 'r', encoding="utf-8") as file:
...
def clean_console_output_to_file():
    ...
    for line in texts:
        ...
        with open('../word2vec/translations/questions-words-cs-translated_so_far.txt', 'w+',
