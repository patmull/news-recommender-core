...
class UserBasedRecommendation:
    ...
    def get_user_keywords(self, user_id):
        ...
        sql_user_keywords = """SELECT multi_dimensional_list.name AS "keyword_name" FROM tag_user tu JOIN tags multi_dimensional_list ON multi_dimensional_list.id = tu.tag_id WHERE tu.user_id = (%(user_id)s);"""
        queryParams = {'user_id': user_id}
